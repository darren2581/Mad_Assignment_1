    ...
    public class Board6x5 extends AppCompatActivity {

        private int[][] board6x5; //2D array for the game board
        private int rows = 6; // num of rows
        private int cols = 5; // num of cols
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            board6x5 = new int[rows][cols]; // initialise empty board
        ...
        public boolean checkDraw() {
            for (int row = 0; row < board6x5.length; row++) {
                for (int col = 0; col < board6x5[row].length; col++) {
                    if (board6x5[row][col] == 0) { // if board is not full
                        return false;
                    }
                }
                }
